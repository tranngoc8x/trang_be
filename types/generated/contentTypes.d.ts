...
export interface ApiBaoGiaAndTuVanBaoGiaAndTuVan
  extends Struct.CollectionTypeSchema {
  collectionName: 'bao_gia_and_tu_vans';
  info: {
    description: '';
    displayName: 'B\u00E1o gi\u00E1 & t\u01B0 v\u1EA5n';
    pluralName: 'bao-gia-and-tu-vans';
    singularName: 'bao-gia-and-tu-van';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bao-gia-and-tu-van.bao-gia-and-tu-van'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageContentHomePageContent
  ...
  attributes: {
    aboutus: Schema.Attribute.Component<'shared.article', false>;
    company_achievement: Schema.Attribute.Component<'shared.rich-text', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    news: Schema.Attribute.Component<'shared.article', false>;
    partner: Schema.Attribute.Component<'shared.article', false>;
    publishedAt: Schema.Attribute.DateTime;
    service: Schema.Attribute.Component<'shared.article', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    show_in_home: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bao-gia-and-tu-van.bao-gia-and-tu-van': ApiBaoGiaAndTuVanBaoGiaAndTuVan;
